...
const imageLinkEl = document.getElementById("accordionImageLink");

function updateAccordionImage(index) {
    ...
    setTimeout(() => {
        ...
        if (data.link) {
            imageLinkEl.href = data.link;
            imageLinkEl.style.pointerEvents = "auto";
        } else {
            imageLinkEl.href = "#";
            imageLinkEl.style.pointerEvents = "none";
        }
    ...
    accordionItems.forEach(item => {
        ...
        function toggleAccordion() {
            ...
            if (isActive) {
                ...
                updateAccordionImage(item.dataset.index);
            }
        }
